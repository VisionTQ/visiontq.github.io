...
![UAP profile page](/assets/img/uap-profile.png)
...
![Scholarship data tab](/assets/img/uap-scholarship-data.png)

The only undergraduate universities that accept the DET in 2026 are:

- **King Fahd University of Petroleum & Minerals** — [admissions.kfupm.edu.sa](https://admissions.kfupm.edu.sa/en/important-dates/track-detail/early-track)
- **Prince Sultan University** — [psu.edu.sa](https://www.psu.edu.sa/en/admissions-Undergraduate-Admission)
- **Saudi Electronic University**

This information is based on the [Duolingo English Test accepting institutions page](https://englishtest.duolingo.com/accepting_institutions). To check the latest undergraduate programs that accept the DET, visit that link.

### Understanding the Wishlist

When adding a wishlist, if you see a trophy cup icon near your program:

![Trophy cup icon on wishlist](/assets/img/uap-wishlist-trophy.png)
